...
<head>
	...
	<script type="text/javascript" src="js/board/modifySCMenteeBoard.js"></script>
	...
	<div class="container-wrap">
 	...
 	<div class="container-wrap">
 		<div class="row">
 			...
 			<div class="col-sm-10">
			    <form action="/modifySCMenteeBoard.do" method="post" id="modifyBoardFrm" enctype="multipart/form-data">
			    	<div class="row">&nbsp;</div>
			    	<div class="row">
