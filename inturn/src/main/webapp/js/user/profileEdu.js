...
function setEduLvlList(data){
	...
	for(var i=0 ; i< data.eduLvlList.length; i++){
		...
		a += '<input type="button" id="btn_education" class="btn btn-primary" value="수정" onclick="modifyEduForm('+ data.eduLvlList[i].eduLevel_num+')">';
...
function setModifyEduForm(data){
	...
	a += '<div class="row">';
	a += '<div class="col-sm-6">';
	a += '<label class="col-form-label label-edu" for="school_name'+ data.eduLvl.eduLevel_num+'">학교명</label>';
	a += '<input type="text" id="school_name'+ data.eduLvl.eduLevel_num+'" class="form-control" readonly="" value="'+ data.eduLvl.school_name+'" onclick="modifySchoolModal('+ data.eduLvl.eduLevel_num+')">';
	a += '</div>';
	a += '<div class="col-sm-6">';
	a += '<label class="col-form-label label-edu" for="degree_level'+ data.eduLvl.eduLevel_num+'">구분</label>';
	a += '<input type="text" id="degree_level'+ data.eduLvl.eduLevel_num+'" class="form-control" readonly="" value="'+ data.eduLvl.degree_level+'">';
	a += '</div>';
	a += '</div>';
	a += '<div class="row">';
	a += '<div class="col-sm-4">';
	a += '<label class="col-form-label label-edu" for="admission_date'+ data.eduLvl.eduLevel_num+'">입학일</label>';
	a += '<input type="date" id="admission_date'+ data.eduLvl.eduLevel_num+'" class="form-control" value="'+ data.eduLvl.admission_date+'">';
	a += '</div>';
	a += '<div class="col-sm-4">';
	a += '<label class="col-form-label label-edu" for="graduation_date'+ data.eduLvl.eduLevel_num+'">졸업일</label>';
	a += '<input type="date" id="graduation_date'+ data.eduLvl.eduLevel_num+'" class="form-control" value="'+ data.eduLvl.graduation_date+'">';
	a += '</div>';
	a += '<div class="col-sm-4">';
	a += '<label class="col-form-label label-edu" for="current_status'+ data.eduLvl.eduLevel_num+'">현재상태</label>';
	a += '<select id="current_status'+ data.eduLvl.eduLevel_num+'" class="form-control">'
	...
	a += '<div class="row">';
	a += '<div class="col-sm-6">';
	a += '<label class="col-form-label label-edu" for="major'+ data.eduLvl.eduLevel_num+'">전공</label>';
	a += '<input type="text" id="major'+ data.eduLvl.eduLevel_num+'" class="form-control" value="'+ data.eduLvl.major+'">';
	a += '</div>';
	a += '<div class="col-sm-1"></div>';
	a += '<div class="col-sm-5">';
	a += '<label class="col-form-label label-edu" for="avg_score'+ data.eduLvl.eduLevel_num+'">학점 / 총점</label>';
	a += '<div>';
	a += '<input type="text" id="avg_score'+ data.eduLvl.eduLevel_num+'" class="form-control avg_score" value="'+ data.eduLvl.avg_score+'"> <span>/</span>';
	a += '<select id="total_score'+ data.eduLvl.eduLevel_num+'" class="form-control total_score">';
	...
	a += '</div>';
	a += '</div>';
	a += '<div id="box_modifyEduBtn'+ data.eduLvl.eduLevel_num+'" class="box_eduBtn">';
	a += '<input type="button" id="btn_modifyEdu" class="btn btn-primary" value="저장" onclick="modifyEdu('+ data.eduLvl.eduLevel_num+')">';
	a += '<input type="button" id="btn_cancelModifyEdu" class="btn btn-default" value="취소" onclick="cencelModifyEdu('+ data.eduLvl.eduLevel_num+')">';
	a += '</div>';
