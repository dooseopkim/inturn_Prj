...
public class QnABoardVO {
	private int qna_num;    	//INT           NOT NULL COMMENT 'qna_num', -- qna_num
	...
	public QnABoardVO(int qna_num, int grpno, int grpord, int dept, String title, String content, Date regDate,
			String makePublic, String pw, String id) {
	...
	public String toString() {
		return "QnABoardVO [qna_num=" + qna_num + ", grpno=" + grpno + ", grpord=" + grpord + ", dept=" + dept
				+ ", title=" + title + ", content=" + content + ", regDate=" + regDate + ", makePublic=" + makePublic
				+ ", pw=" + pw + ", id=" + id + "]";
	}
